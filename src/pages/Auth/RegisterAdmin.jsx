...
import { setToken } from "../../redux/Registerapi/RegisterAdmin"; // путь поправь
...
const handleSubmit = async (e) => {
 ...
 if (valid) {
  try {
    ...
    localStorage.setItem("token", res.token); // <-- добавь это!
  ...
  useEffect(() => {
    if (messageValid) {
      const timer = setTimeout(() => setMessageValid(false), 6000);
    ...
    <div className="auth">
      <div className="auth__container">
        ...
        <div className="auth__container__down__title">
          <li onClick={() => navigate("/sign-in")}>Вход</li>
          <div>
