...
const Courses1detail = () => {
    ...
    const getSlidesPerView = () => {
        ...
        if (windowWidth < 964) return 2.12;
        return 3.12;
    };
    ...
    return (
        <div className="max-w-[1230px] mx-auto bg-white relative">
            <div className="mb-6">
                <div className="max-w-[1160px] flex justify-between items-center mb-6">
                    <h2 className="text-3xl font-bold">Курсы ментора</h2>
...
const renderCourseCard = (course, logAction, toggleFavorite, favorites, openModal) => {
    ...
    return (
        <div
            className="bg-white w-full w-[380px] rounded-[25px] border border-gray-100 min-h-[400px] shadow-lg overflow-auto"
